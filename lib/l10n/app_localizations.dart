...
abstract class AppLocalizations {
  ...
  /// No description provided for @enableGemini3Title.
  ///
  /// In en, this message translates to:
  /// **'Enable Gemini 3'**
  String get enableGemini3Title;

  /// No description provided for @enableGemini3Subtitle.
  ///
  /// In en, this message translates to:
